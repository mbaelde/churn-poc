...
class ChurnModel:
    ...
    def train(self, X: pd.DataFrame, y: pd.DataFrame, preprocess_features: bool = True) -> "ChurnModel":
    ...
    def predict(self, X: pd.DataFrame, preprocess_features: bool = True) -> pd.DataFrame:
